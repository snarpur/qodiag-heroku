...
questionnaire_definition = [
  {:question_group => 'anxious/depressed', :common_identifier => "internalizing",  :order => [14,29,30,31,32,33,35,45,50,52,71,91,112]},
  {:question_group => 'withdrawn/depressed', :common_identifier => "internalizing", :order => [5,42,65,69,75,102,103,111]},
  {:question_group => 'somatic_complaint', :common_identifier => "internalizing", :order => [47,51,54,56]},
  ...
  {:question_group => 'rule-breaking_behaviour', :common_identifier => "externalizing", :order => [2,26,28,39,43,63,67,72,81,82,90,96,99,101,105]},
  {:question_group => 'aggressiv behaviour', :common_identifier => "externalizing", :order => [3,16,19,20,21,22,23,37,57,68,86,87,89,94,95,97,104]},
