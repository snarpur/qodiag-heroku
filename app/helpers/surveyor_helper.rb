module SurveyorHelper
  ...
  def q_text(obj)
    ...
    return I18n.t("surveys.#{obj.common_namespace}.questions")[obj.display_order] if obj.is_a?(Question) and (obj.dependent? or obj.display_type == "label" or obj.part_of_group?)
    "#{@n += 1}) #{obj.text}"
  end
