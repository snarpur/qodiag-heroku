...
FactoryGirl.define do
  sequence :unique_survey_access_code do |n| 
    "simple_survey" << rand(1000000).to_s
  end
...
# FactoryGirl.define :survey_section do |s|
...
# FactoryGirl.define :question do |q|
...
# FactoryGirl.define :question_group do |g|
...
# FactoryGirl.define :answer do |a|
...
# FactoryGirl.define :dependency do |d|
...
# FactoryGirl.define :dependency_condition do |d|
...
# FactoryGirl.define :response_set do |r|
#   r.user_id         {}
...
# FactoryGirl.define :response do |r|
...
# FactoryGirl.define :validation do |v|
#   v.association       :answer # v.answer_id         {}
#   v.rule              {"A"}
#   v.message           {}
# end

# FactoryGirl.define :validation_condition do |v|
