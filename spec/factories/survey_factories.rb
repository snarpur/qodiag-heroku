...
# FactoryGirl.sequence(:unique_survey_access_code){|n| "simple_survey" << rand(10000000).to_s }
...
FactoryGirl.define do
  ...
  factory :survey_section do |s|
    ...
    s.display_order             { next(:survey_section_display_order)}
  ...
  factory :question do |q|
    ...
    q.common_namespace        {}
    q.common_identifier       {}
    q.display_order           {next(:question_display_order)}
  ...
  factory :answer do |a|
    ...
    a.common_namespace          {}
    a.common_identifier         {}
    a.display_order             {next(:answer_display_order)}
    a.is_exclusive              {}
    a.hide_label                {}
    a.display_length            {}
    a.custom_class              {}
